...
This is the readme for DodgetheCreeps, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. DodgetheCreeps) > Ok.
...
- To run the project find DodgetheCreeps.java (which will be in under src/main/java/com/mygame) and right click > Run 'DodgetheCreeps'
